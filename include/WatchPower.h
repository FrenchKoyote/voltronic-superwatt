...
private:
    ...
    static constexpr char *CMD_GENERAL_STATUS = "\x51\x50\x49\x47\x53\xB7\xA9\x0D";
    /* Device Mode inquiry */
    //static constexpr char *CMD_MODE_INQUIRY = "QMOD\x49\xC1";
    static constexpr char *CMD_MODE_INQUIRY = "\x51\x4D\x4F\x44\x49\xC1\x0D";
...
public:
    ...
    floatEntry RSV1;
    floatEntry RSV2;
    floatEntry solarInputPower;
    statusEntry status;
    warningEntry warning;
    status2Entry status2;
